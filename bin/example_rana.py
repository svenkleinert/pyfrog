...
import pyfrog.gui
"""
Example file showing the retrieval of an synthetic frog trace using the rana multigrid retrieval.
"""
def main():
    # frequency axis
    f_width = 200e12
    ...
    E = pyfrog.retrieval.rana_phase( trace, spectrum=ret_spectrum, phase=np.zeros(Nf), l=2, max_iter=30, g_limit=0 )
